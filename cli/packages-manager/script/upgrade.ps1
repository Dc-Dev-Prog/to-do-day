...
function New-ReporteUpgrade {
    ...
    $reportDir = Join-Path (Split-Path $PSScriptRoot) "reports\upgrade\$($NetworkName.ToLower())"
...
Write-Host "`n🎉 Completado! Reportes guardados en .\reports\upgrade\" -ForegroundColor Green
